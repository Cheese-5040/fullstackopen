...
const App = () => {
    ...
    const [left, setLeft] = useState(0) // usestate must not be called from inside a loop, a conditional expression or anyplace that is not a funciton of defining a component
